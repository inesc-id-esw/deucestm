 ...
 */
@Exclude
public class StaticIntPointGcTest extends RunTestGcBodiesHistory<Integer>{
		...
		try {
			fields = new PointFields<Integer>(
					(Class<Point<Integer>>) Class.forName(
							StaticIntPoint.class.getName() + "__STATICFIELDS__"));
		} catch (ClassNotFoundException e) {
			throw new RuntimeException(e);
		}
	}
	public StaticIntPointGcTest() {
		super(new StaticIntPointFactory(), fields);
	}
