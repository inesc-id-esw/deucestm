...
public class StaticIntegerPointFactory implements PointFactory<Integer>{
    @Override
    public Point<Integer> make(Number paramInt1, Number paramInt2) {
	PointTrxUtil.staticPartToCompactLayout(StaticIntegerPoint.class);
	return new StaticIntegerPoint(paramInt1, paramInt2);
    }
}
